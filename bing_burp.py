...
class BurpExtender(IBurpExtender, IContextMenuFactory):
    def registerExtendedCallbacks(self, callbacks):
    ...
    def bing_query(self, bing_query_string):
        ...
        http_request += '0cp-Apim-Subscription-Key: %s\r\n' % API_KEY
        http_request += 'User-Agent: Black Hat Python\r\n\r\n'
        
        json_body = self.callbacks.makeHttpRequest(API_HOST, 443, True, http_request).tostring()
